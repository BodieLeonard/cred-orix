...
function orix_scripts() {
	...
	wp_enqueue_script( 'orix-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );
	
	wp_enqueue_script( 'orix-app', get_template_directory_uri() . '/js/orix.js', array(), '20140715', true );

	wp_enqueue_script( 'orix-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
