...
get_header(); ?>
	...
	<div id="primary" class="content-area">
		...
		if(!empty($qstring)) {
			...
			$filter = 'community-'.$_REQUEST['filter'];
			query_posts(array( 'post_type' => 'community', 'post_status'=>'publish', 'posts_per_page' => -1, 'orderby'=> 'menu_order', 'order' => 'ASC', "communitycategory"=>$filter)); 
		} else {
			query_posts(array( 'post_type' => 'community', 'post_status'=>'publish', 'posts_per_page' => -1, 'orderby'=> 'menu_order', 'order' => 'ASC')); 
		}
		?>
		...
		<?php #get_template_part( 'content', 'sidebar-community' ); ?>
